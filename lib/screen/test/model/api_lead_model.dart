...
//
//     final responseLeadModel = responseLeadModelFromJson(jsonString);

import 'dart:convert';

ResponseLeadModel responseLeadModelFromJson(String str) => ResponseLeadModel.fromJson(json.decode(str));

String responseLeadModelToJson(ResponseLeadModel data) => json.encode(data.toJson());

class ResponseLeadModel {
    bool success;
    Data data;
    String message;
    dynamic errors;
    ...
    factory ResponseLeadModel.fromJson(Map<String, dynamic> json) => ResponseLeadModel(
